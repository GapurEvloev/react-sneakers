      ...
      <header className="header">
        <div className="header__logo">
          ...
          <div className="header__logo-text">
            ...
            <p className="header__logo-slogan">
              Самые лучше кроссовки
            </p>
          </div>
        </div>
        <ul className="header__sign sign d-flex">
          <li className="header__sign-item sign-cart">
            <svg className="sign-cart__icon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className="sign-cart__sum">1205 руб.</span>
          </li>
          <li className="header__sign-item favorites">
            <svg className="favorites__icon" width="22" height="19" viewBox="0 0 22 19" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <li className="header__sign-item sign-user">
            <svg className="sign-user__icon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
